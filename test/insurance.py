...
class UserBehaviour(TaskSet):
    ...
    class AutoQuoteModule(SequentialTaskSet):
        ...
        def complete_step_1(self):
            ...
            response = self.client.post("/quote_auto.jsf", name="Auto Quote step 1", cookies=self.parent.cookies,
                                        data=payload)
        ...
        def complete_step_2(self):
            ...
            response = self.client.post("/quote_auto2.jsf", name="Auto Quote step 2", cookies=self.parent.cookies,
                                        data=payload)
        ...
        def complete_step_3(self):
            ...
            response = self.client.post("/quote_auto3.jsf", name="Auto Quote step 3", cookies=self.parent.cookies,
                                        data=payload)
        ...
        def proceed_to_result(self):
            ...
            response = self.client.post("/quote_result.jsf", name="Proceed to quote result",
                                        cookies=self.parent.cookies, data=payload)
        ...
        def purchase_quote(self):
            ...
            response = self.client.post("/purchase_quote.jsf", name="Purchase quote", cookies=self.parent.cookies,
                                        data=payload)
    ...
    class AgentLookupModule(SequentialTaskSet):
        ...
        def select_agent_lookup(self):
            ...
            response = self.client.get("/agent_lookup.jsf", name="Select agent lookup", cookies=self.parent.cookies)
        ...
        def search_all_agents(self):
            ...
            response = self.client.post("/agent_lookup.jsf", name="Search all agents", cookies=self.parent.cookies,
                                        data=payload)
